      ...
      <div class="rw">
        <div class="col-sm-2" style="background-image: url('img/bg/Advert.jpeg');">
          ...
          <div class="list-group" >
            <a href="web.php" class="list-group-item list-group-item-warning" >EXPLORE &nbsp;<span class="glyphicon glyphicon-search"></span></a>
            <a href="#" class="list-group-item list-group-item-action list-group-item-warning">ARTISTS &nbsp;<span class="glyphicon glyphicon-user"></span></a>
            <a href="#" class="list-group-item list-group-item-action list-group-item-warning">GENRE &nbsp;<span class="glyphicon glyphicon-music"></span></a>
            <a href="#" class="list-group-item list-group-item-warning list-group-item-info" data-toggle="modal" data-target="#myModal">MUSIC &nbsp; <span class="glyphicon glyphicon-film" ></span></a>
...
//   $name=$_SESSION['email'];
            ...
            <div class="col-sm-2" style="height:100%;background-image: url('img/bg/dAdvert.jpeg');">
                ...
                <img src="img/bg/Advert.jpeg" style="width: 100%">
...
// $searchId=preg_replace("#[^0-9a-z]#i", "", $searchIdd);
//  echo " id is". $seachId;
                  $getAds=("SELECT * FROM ads ORDER BY RAND()LIMIT 4");
                  $adResult = mysqli_query($conn,$getAds) or die("Failed: ".mysqli_error($conn));
                  while($all_ads=mysqli_fetch_array($adResult))
                  {
                    ?>
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="ads/<?php echo $all_ads['fileName']; ?>"  type="image" ></iframe>
                      </div>
